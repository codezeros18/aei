      ...
      <div class="mx-auto max-w-1xl py-16 sm:py-21 lg:py-32 lg:px-2 lg:mx-40 md:mx-20 md:py-20 sm:mx-0 font-montserrat">
        <div class="text-left">
            <div class="flex gap-x-2">
                ...
                <a href="aut" class="text-[14px] leading-[3rem] font-normal text-white tracking-wide lg:text-[17px] hover:text-orangenav  delay-50 duration-300">AUTOMATION</a>
            </div>
            <h1 class="text-[20px] font-semibold leading-none pb-9 text-white tracking-normal md:text-[27px] lg:text-[40px]">Automation</h1>
            <p class="text-[15px] leading-6 font-normal text-white md:text-[15px] lg:text-[18px] tracking-tight font-roboto">
                Automation uses technology to perform tasks with minimal human intervention.</p>
        </div>
      </div>
    </div>
</div>
    ...
    <div class="flex flex-col lg:flex-row">
        <div class="flex-auto px-4 w-full lg:w-6 order-3 lg:order-1"> <!-- Updated order for small screens -->
            ...
            <ul class="pt-4 font-roboto text-[15px] tracking-normal font-normal">
                <li class="border-b-2 border-bordertrans py-2 my-1">
                    <a class="text-orangenav" href="aut">Automation</a>
                </li>
                <li class="border-b-2 border-bordertrans py-2 my-1">
                    <a class="hover:text-orangenav  delay-50 duration-300" href="iot">IOT</a>
                </li>
            </ul>
        </div>
        <div class="flex-auto px-4 w-auto lg:w-48 order-1 lg:order-2"> <!-- Updated order for small screens -->
            <div>
                ...
                <h1 class="half-border text-[18px] font-semibold py-4 leading-[3.25rem] tracking-normal md:text-[23px] lg:text-[40px]">Automation</h1>
                <p class="py-4 text-[15px] leading-7 font-normal tracking-wider font-roboto">The use of technology to perform tasks with minimal human intervention. It involves the application of machines, control systems, and software to operate processes and systems efficiently and accurately. Automation can be applied across various domains, from industrial manufacturing to office administration, and it is designed to increase productivity, improve quality, reduce errors, and lower costs.</p>
            </div>
        </div>
        <div class="flex-auto px-4 w-auto pb-10 lg:w-48 order-2 lg:order-3"> <!-- No need to change order for small screens -->
            <div class="group cursor-pointer">
                <img src="img/au10.jpg" class="w-full h-[310px] pb-4" alt="" onclick="openModal('img/au10.jpg')">
                <img src="img/au11.jpg" class="w-full h-[310px] pb-4" alt="" onclick="openModal('img/au11.jpg')">
            </div>
        </div>
    </div>
</div>
