      ...
      <div class="mx-auto max-w-1xl py-16 sm:py-21 lg:py-32 lg:px-2 lg:mx-40 md:mx-20 md:py-20 sm:mx-0 font-montserrat">
        <div class="text-left">
            <div class="flex gap-x-2">
                ...
                <a href="gob" class="text-[14px] leading-[3rem] font-normal text-white tracking-wide lg:text-[17px] hover:text-orangenav  delay-50 duration-300">GOB</a>
            </div>
            <h1 class="text-[20px] font-semibold leading-none pb-9 text-white tracking-normal md:text-[27px] lg:text-[40px]">Gas & Oil Boiler</h1>
            <p class="text-[15px] leading-6 font-normal text-white md:text-[15px] lg:text-[18px] tracking-tight font-roboto">
                Gas boilers are powered by natural gas or propane and are more efficient than standard boilers.</p>
        </div>
      </div>
    </div>
</div>
    ...
    <div class="flex flex-col lg:flex-row">
        <div class="flex-auto px-4 w-full lg:w-6 order-3 lg:order-1"> <!-- Updated order for small screens -->
            ...
            <ul class="pt-4 font-roboto text-[15px] tracking-normal font-normal">
                ...
                <li class="border-b-2 border-bordertrans py-2 my-1">
                    <a class="text-orangenav" href="gob">Gas & Oil Boiler</a>
                </li>
                <li class="border-b-2 border-bordertrans py-2 my-1">
        ...
        <div class="flex-auto px-4 w-auto lg:w-48 order-1 lg:order-2"> <!-- Updated order for small screens -->
            <div>
                ...
                <h1 class="half-border text-[18px] font-semibold py-4 leading-[3.25rem] tracking-normal md:text-[23px] lg:text-[40px]">Gas & Oil Boiler</h1>
                <p class="py-4 text-[15px] leading-7 font-normal tracking-wider font-roboto">Gas boilers are powered by natural gas or propane and are more efficient than standard boilers. The fuel for a gas boiler is piped into the boiler from an outside source that is connected directly to the boiler. The distribution of heat using a gas steam boiler depends on its configuration.</p>
                <p class="py-4 text-[15px] leading-7 font-normal tracking-wider font-roboto">Gas steam boilers can be used for industrial purposes and low-pressure applications.</p>
            </div>
        </div>
        <div class="flex-auto px-4 w-auto pb-10 lg:w-48 order-2 lg:order-3"> <!-- No need to change order for small screens -->
            <div class="group cursor-pointer">
                <img src="img/gaoi3a.jpg" class="w-full h-[310px] pb-4 object-cover object-center" alt="" onclick="openModal('img/gaoi3a.jpg')">
                <img src="img/gaoi4a.jpg" class="w-full h-[310px] pb-4 object-cover object-center" alt="" onclick="openModal('img/gaoi4a.jpg')">
            </div>
        </div>
    </div>
</div>
